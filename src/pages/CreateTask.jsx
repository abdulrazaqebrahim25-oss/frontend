    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            if (reminders.length > 0) {
                ...
                const updatedList = [...existing, ...formattedReminders]
                localStorage.setItem('localReminders', JSON.stringify(updatedList))
            }
            ...
            if (reminders.length > 0) {
                ...
                localStorage.setItem('localReminders', JSON.stringify([...existing, ...formattedReminders]))
            }
        }
    }
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <select name="routine" value={formData.routine} onChange={handleChange}>
